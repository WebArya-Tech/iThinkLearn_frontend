...
export default function About() {
  ...
  return (
    <div className="bg-white">
      ...
      <main>
        {/* Hero Section */}        <div className="py-12 lg:py-15  text-black">
        ...
        <div className="py-12 bg-blue-500">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
              ...
              <a href="tel:+918861919000" className="bg-transparent border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold hover:bg-white hover:text-blue-600 transition inline-flex items-center justify-center gap-2 text-sm sm:text-base">
