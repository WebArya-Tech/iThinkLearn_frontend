  ...
  return (
    <footer id="contact" className="bg-linear-to-b from-blue-900 to-indigo-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Top divider accent */}
        <div className="h-1 w-full bg-linear-to-r from-yellow-400 via-orange-500 to-yellow-400 rounded-full mb-0" />
          ...
          <div>
            <div>
              ...
              <div className="space-y-4 text-blue-200 text-xs sm:text-sm pl-1">
                ...
                <div className="flex flex-col gap-1">
                  <p className="font-semibold text-white text-xs uppercase tracking-wide">Call / WhatsApp</p>
                  <a href="tel:+918197466607" className="hover:text-yellow-400 transition">+91 819 746 6607</a>
                  <a href="tel:+917795010900" className="hover:text-yellow-400 transition">+91 779 501 0900</a>
                </div>
                <div className="flex flex-col gap-1">
                  <p className="font-semibold text-white text-xs uppercase tracking-wide">WhatsApp Direct</p>
                  <a href="https://wa.me/919187385124" target="_blank" rel="noopener noreferrer"
