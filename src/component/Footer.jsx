  ...
  return (
    <footer id="contact" className="bg-linear-to-b from-blue-900 to-indigo-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Footer Grid */}
        <div className="py-8 sm:py-12 lg:py-14 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">

          {/* ── Column 1: Brand ── */}
          <div className="md:col-span-2 xl:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-4 hover:opacity-85 transition w-fit mx-auto sm:mx-0">
              <img src="/logo.jpeg" alt="iThinkLearn Logo" className="h-10 sm:h-12 lg:h-13 w-auto rounded-lg shadow-md" />
              <h3 className="text-lg sm:text-xl lg:text-2xl font-extrabold tracking-tight">iThinkLearn</h3>
            </Link>
            <p className="text-yellow-400 font-semibold text-xs sm:text-sm mb-3 text-center sm:text-left">Global Excellence in Mathematics</p>
            ...
            <div className="mt-6 pt-4 border-t border-white/20">
              <h4 className="flex items-center gap-2 text-sm font-bold mb-3 text-white uppercase tracking-wider">
              ...
              <div className="mt-4 pt-3 border-t border-white/20">
                <button
                  ...
                  className="text-yellow-400 font-semibold text-sm hover:text-yellow-300 transition flex items-center gap-2"
                >
            ...
            <div>
              ...
              <div className="space-y-4 text-blue-200 text-xs sm:text-sm pl-1">
                <div className="flex flex-col gap-1">
                  ...
                  <a href="mailto:ithinklearn@ixpoe.com" className="flex items-center gap-2 hover:text-yellow-400 transition">
                    <svg className="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <a href="tel:+917795010900" className="flex items-center gap-2 hover:text-yellow-400 transition">
                    <svg className="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* Social Icons */}
            <div className="flex gap-3 justify-center sm:justify-start flex-wrap mb-6">
        ...
        {/* Bottom Footer */}
        <div className="border-t border-blue-700/60 py-4 sm:py-6 flex flex-col gap-3 sm:gap-4 lg:flex-row lg:justify-between lg:items-center">
          <p className="text-blue-300 text-xs sm:text-sm text-center lg:text-left order-2 lg:order-1">
            2026 iThinkLearn Tuitions. All rights reserved.
          </p>

          <div className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-blue-300 flex-wrap justify-center order-1 lg:order-2">
