...
const DEFAULT_CLASSES = [
  ...
  { id: 2, subject: 'UG Physics', level: 'Undergraduate', instructor: 'Mr. Arvind', schedule: 'Tue, Thu - 5:30 PM IST', students: '10-12', description: 'Advanced physics concepts with real-world applications', image: '', status: 'Active', enrolledStudents: [] },
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`inline-block px-2 py-1 rounded text-sm font-semibold text-white ${
                          c.status === 'Active' ? 'bg-blue-900' : c.status === 'Inactive' ? 'bg-gray-500' : 'bg-green-600'
                        }`}
                      >
                        {c.status}
                      </span>
