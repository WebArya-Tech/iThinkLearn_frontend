...
const DEFAULT_COURSES = [
  ...
  { id: 2, name: 'UG Physics', description: 'Advanced physics concepts with real-world applications', instructor: 'Mr. Arvind', duration: '6 months', price: 12000, category: 'Physics' },
