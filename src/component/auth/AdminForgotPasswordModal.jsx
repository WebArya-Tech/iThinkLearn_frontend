...
export default function AdminForgotPasswordModal({ isOpen, onClose, onOpenLogin }) {
  ...
  const stepTitles = { 1: 'Admin Forgot Password', 2: 'Verify OTP', 3: 'Reset Password', 4: 'Success!' }
  const stepSubtitles = {
    1: 'Enter your registered admin email to receive OTP',
    2: `OTP sent to ${email}`,
    3: 'Create your new admin password',
    4: 'Your admin password has been reset successfully'
  }
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[92vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        ...
        <div className="relative bg-blue-900 px-6 pt-8 pb-6 sticky top-0 z-10">
          ...
          <div className="flex justify-between items-start">
            ...
            <button onClick={handleClose} className="text-blue-300 hover:text-white text-2xl font-bold transition leading-none mt-0.5">&times;</button>
          </div>
        </div>
            ...
            <form onSubmit={handleSendOtp} noValidate>
              <div className="space-y-4">
                <div className="bg-blue-50 border-l-4 border-blue-900 rounded-r-xl p-4">
                  <p className="text-sm text-gray-700">We'll send a 6-digit OTP to your registered admin email.</p>
                  <p className="text-xs text-orange-600 font-semibold mt-1">OTP is valid for 5 minutes only.</p>
                </div>
                <div>
            ...
            <form onSubmit={handleVerifyOtp} noValidate>
              <div className="space-y-4">
                <div className="bg-blue-50 border-l-4 border-blue-900 rounded-r-xl p-4">
                  ...
                  <p className="text-xs text-orange-600 font-semibold mt-1">This OTP is valid for 5 minutes only.</p>
                </div>
            ...
            <form onSubmit={handleResetPassword} noValidate>
              <div className="space-y-4">
                <div className="bg-blue-50 border-l-4 border-yellow-400 rounded-r-xl p-4 flex items-center gap-3">
                  <span className="text-yellow-500 text-xl shrink-0">OK</span>
                  <p className="text-sm text-gray-700 font-semibold">OTP Verified! Set your new admin password below.</p>
                </div>
            ...
            <div className="space-y-5 text-center py-4">
              <div className="flex flex-col items-center gap-4">
                <div className="w-20 h-20 bg-blue-900 rounded-full flex items-center justify-center shadow-lg">
                  <span className="text-yellow-400 text-4xl font-black">OK</span>
                </div>
                <div>
                  <h3 className="text-xl font-black text-blue-900">Password Reset!</h3>
                  <p className="text-gray-500 text-sm mt-1">You can now login with your new admin password.</p>
                </div>
              </div>
