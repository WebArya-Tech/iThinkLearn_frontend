...
export default function AdminLoginModal({ isOpen, onClose, onOpenForgotPassword }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Admin login error:', apiError)
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden" onClick={e => e.stopPropagation()}>
        ...
        <div className="relative bg-blue-900 px-6 pt-8 pb-6">
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-blue-300 mt-1 text-sm">Access administrator dashboard</p>
            </div>
        ...
        <form onSubmit={handleSubmit} className="px-6 py-6">
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="admin-email" className="block text-xs font-bold mb-1.5 text-blue-900 uppercase tracking-wide">Admin Email</label>
              <input
                type="email"
                id="admin-email"
                required
            ...
            <div>
              <label htmlFor="admin-password" className="block text-xs font-bold mb-1.5 text-blue-900 uppercase tracking-wide">Password</label>
